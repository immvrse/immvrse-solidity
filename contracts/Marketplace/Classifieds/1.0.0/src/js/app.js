...
App.loading=true;
       ...
       var classifiedsInstance;

       App.contracts.Classifieds.deployed().then(function(instance){

         classifiedsInstance = instance;
         return classifiedsInstance.getArticlesForSale();
       }).then(function(articleIds){
        //retrieve the article placeholder and clear interval and clear it

        $('#articlesRow').empty();

        for (var i=0 ; i<articleIds.length;i++){
          var articleId = articleIds[i];
          classifiedsInstance.articles(articleId.toNumber()).then(function(article){
